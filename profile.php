        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 offset-2">Admin Profile</h1>
...
?>
                                ...
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info">Registration Date: <?php  echo $row['AdminRegdate'];?></h6>
                                </div>
                                <div class="card-body">
...
<?php } ?>
        <div class="form-group">
                                 <input type="submit" class="btn btn-info btn-user btn-block" name="update" id="update" value="Update">                           
                             </div>                                        
