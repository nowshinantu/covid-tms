  <!-- Navigation -->
  <nav class="navbar navbar-expand-lg navbar-primary bg-light fixed-top" id="mainNav" style="border-bottom: 2px solid cadetblue;">
    <div class="container-fluid">
      <a class="navbar-brand js-scroll-trigger" href="#page-top"><h4 style="color:cadetblue; font-weight:bold;"><i class="fa-solid fa-virus-covid"></i> Covid19 Test Management system</h4></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link js-scroll-trigger" href="index.php"  style="color:cadetblue;"><i class="fa-solid fa-house"></i> Home</a>
          </li>
          <li class="nav-item active">
