...
echo '<script>alert("Assigned to Doctor successfully.")</script>';
...
<form method="post">
        ...
        <?php } ?>
            ...
            <p>
     <input type="submit" class="btn btn-info btn-user btn-block" name="submit" id="submit">   </p> 
...
<!-- <textarea name="remark" class="form-control" required="true" placeholder="Remark (Max 500 Characters)" maxlength="500" rows="5"></textarea>  </p>  -->
  <p>
     <input type="submit" class="btn btn-info btn-user btn-block" name="takeaction" id="submit">   </p> 
