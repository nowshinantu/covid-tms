        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-3">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 bg-gradient-light text-center">Already Registeres Users Check</h1>
...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="Please enter your registered mobile number" pattern="[0-9]{11}" title="11 numeric characters only" required="true" maxlength="11">
                                        </div>
<div class="form-group">
...
<h3 align="center" style="color:lightgreen">Result against mobile number "<?php echo $_POST['regmobilenumber'];?>"</h3>
<hr />
    <?php
